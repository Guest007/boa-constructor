...
class MaskedEditFormatCodesDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.staticText1 = wx.StaticText(id=wxID_MASKEDEDITFORMATCODESDLGSTATICTEXT1,
                                         label=_(
                                             'A string of formatting codes that modify behavior of the control.'),
    ...
    def __init__(self, parent, formatCode=''):
        ...
        self.clbFormatCodes.SetFont(
            wx.Font(
                fontSize,
                wx.MODERN,
                wx.NORMAL,
                wx.BOLD))
        self.tcFormatCodePropVal.SetFont(
            wx.Font(
                fontSize + 1,
                wx.MODERN,
                wx.NORMAL,
        ...
        for fc, desc in formatCodes:
            ...
            if formatCode.find(fc) != -1:
                self.clbFormatCodes.Check(
                    self.clbFormatCodes.GetCount() - 1, True)
