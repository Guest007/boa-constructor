    ...
    def OnSetSourceButton(self, event):
        ...
        try:
            if dlg.ShowModal() == wx.ID_OK:
                ...
                self.targetFolder.SetValue(
                    self.sourceFolder.GetValue() + 'Upgraded')
        finally:
            dlg.Destroy()
...
Plugins.registerTool(
    'wxPython 2.4 to 2.5/2.6 code upgrader',
    showWx25CodeUpgradeDlg)
