...
class MakePyDialog(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.typeLibraryList.SetToolTipString(
            'List of the registered COM type libraries on your system')
        ...
        self.OK = wx.Button(id=wxID_MAKEPYDIALOGOK, label='Generate', name='OK',
                            ...
                            style=0)
        self.OK.SetToolTipString(
            'Click to generate a wrapper for the selected library')
        self.OK.SetConstraints(
            LayoutAnchors(
                self.OK,
                False,
                False,
        ...
        self.bForDemand = wx.CheckBox(id=wxID_MAKEPYDIALOGBFORDEMAND,
                                      ...
                                      style=0)
        self.bForDemand.SetToolTipString(
            'Minimises amount of code generated by only wrapping used classes (recommended).  Clear to generate a single-file wrapper.')
        ...
        self.directSpecification.SetToolTipString(
            'Type text here to search for matching type libraries')
    ...
    def OnOkButton(self, event):
        index = self.typeLibraryList.GetNextItem(-1,
    ...
    def Generate(self, typeLibrary):
        ...
        try:
            ...
            errorMessage = wx.MessageDialog(
                self, str(error), "Generation Failure!", style=wx.OK)
            progress.Destroy()
        ...
        if text:
            ...
            if items:
                for index in range(self.typeLibraryList.GetItemCount()):
                    self.typeLibraryList.SetItemState(
                        index, 0, wx.LIST_STATE_SELECTED)
            ...
            for attribute in ('desc', 'clsid', 'dll',):
                for index in range(len(self.libraryList)):
                    ...
                    try:
                        ...
                        pass
# print error, librarySpecification, attribute, repr(getattr(
# librarySpecification, attribute))
        finally:
            wx.EndBusyCursor()
        return items
