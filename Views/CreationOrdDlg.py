...
class CreationOrderDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.panel1.SetHelpText(
            _('This dialog manages the order of controls on the level (share a parent). When the parent is recreated, the objects will be recreated in the new order.'))
...
if __name__ == '__main__':
    ...
    try:
        dlg.ShowModal()
        print(list(zip(dlg.allCtrlIdxs, dlg.allCtrlNames)))
    finally:
        dlg.Destroy()
