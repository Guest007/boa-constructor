...
def getBoaButtonBitmap():
    return BitmapFromImage(getBoaButtonImage())


def getBoaButtonImage():
    stream = io.StringIO(getBoaButtonData())
...
def getPaletteBitmap():
    return BitmapFromImage(getPaletteImage())


def getPaletteImage():
    stream = io.StringIO(getPaletteData())
    return ImageFromStream(stream)
...
def getDebuggerBitmap():
    return BitmapFromImage(getDebuggerImage())


def getDebuggerImage():
    stream = io.StringIO(getDebuggerData())
    return ImageFromStream(stream)
...
def getCollectionEditorBitmap():
    return BitmapFromImage(getCollectionEditorImage())


def getCollectionEditorImage():
    stream = io.StringIO(getCollectionEditorData())
    return ImageFromStream(stream)
...
def getDesignerBitmap():
    return BitmapFromImage(getDesignerImage())


def getDesignerImage():
    stream = io.StringIO(getDesignerData())
    return ImageFromStream(stream)
...
def getInspectorBitmap():
    return BitmapFromImage(getInspectorImage())


def getInspectorImage():
    stream = io.StringIO(getInspectorData())
    return ImageFromStream(stream)
...
def getEditorBitmap():
    return BitmapFromImage(getEditorImage())


def getEditorImage():
    stream = io.StringIO(getEditorData())
    return ImageFromStream(stream)
...
def getClassBrowserBitmap():
    return BitmapFromImage(getClassBrowserImage())


def getClassBrowserImage():
    stream = io.StringIO(getClassBrowserData())
    return ImageFromStream(stream)
...
def getOutputErrorBitmap():
    return BitmapFromImage(getOutputErrorImage())


def getOutputErrorImage():
    stream = io.StringIO(getOutputErrorData())
    return ImageFromStream(stream)
...
def getHelpImage():
    stream = io.StringIO(getHelpData())
    return ImageFromStream(stream)
...
def getShellBitmap():
    return BitmapFromImage(getShellImage())


def getShellImage():
    stream = io.StringIO(getShellData())
    return ImageFromStream(stream)
...
def getExplorerBitmap():
    return BitmapFromImage(getExplorerImage())


def getExplorerImage():
    stream = io.StringIO(getExplorerData())
    return ImageFromStream(stream)
...
def getZopeBitmap():
    return BitmapFromImage(getZopeImage())


def getZopeImage():
    stream = io.StringIO(getZopeData())
    return ImageFromStream(stream)
