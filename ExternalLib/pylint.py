...
for name in string.split('and break class continue def del elif else except '
                         ...
                         'raise return try while true false') + dir(__builtin__):
    special[name] = 1
member = {}
        ...
        try:
            if last == 'from':
                ...
                try:
                    ...
                    pass
            if type != tokenize.NAME or seen(token):
                return
            ...
            # --
                ...
                pass
            # --
            elif imported(parent) and token in modules[parent]:
                pass
